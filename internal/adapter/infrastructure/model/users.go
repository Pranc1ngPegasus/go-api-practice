...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "email", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"first_name", "last_name", "email", "created_at", "updated_at", "deleted_at"}
